import { ShieldCheck, DollarSign, BarChart3, FlaskConical, ChevronDown } from 'lucide-react'
...
export default function Sidebar({ page, setPage, selectedOrg, setSelectedOrg, orgs }) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-slate-800 flex flex-col z-20 shadow-xl">
      ...
      <div className="px-4 py-4">
        <p className="text-slate-400 text-xs font-semibold uppercase tracking-widest mb-2">Organization</p>
